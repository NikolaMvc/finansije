...
export default function ThemeToggle({ isLight, onToggle }: Props) {
  return (
    <button
      ...
      className="relative flex items-center rounded-full p-[3px] active:opacity-70 transition-opacity"
      style={{
        width: 64,
        height: 32,
    ...
    >
      ...
      {/* Moon icon */}
      <span className="relative z-10 flex items-center justify-center" style={{ width: 29, height: 26 }}>
